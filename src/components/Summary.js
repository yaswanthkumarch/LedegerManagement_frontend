  ...
  return (
    <div className="summary-container">
      ...
      <div className="filter-buttons">
        {/* Filter buttons for different transaction types */}
        <button onClick={() => handleFilter("Tobacco Mastri")}>
          Tobacco Mastri
        </button>
        <button onClick={() => handleFilter("Cows Adduluu Araka")}>
          Cows Adduluu Araka
        </button>
        <button onClick={() => handleFilter("Tobacco Investment")}>
          Tobacco Investment
        </button>
        <button onClick={() => handleFilter("Tobacco Nursery Investment")}>
          Tobacco Nursery Investment
        </button>
        <button onClick={() => handleFilter("Chenega Investment")}>
          Chenega Investment
        </button>
        <button onClick={() => handleFilter("Sell Tobacco")}>Sell Tobacco</button>
        <button onClick={() => handleFilter("Sell Chenega")}>
          Sell Chenega
        </button>
        <button onClick={() => handleFilter("Sell Tobacco Nursery")}>
          Sell Tobacco Nursery
        </button>
        <button onClick={() => handleFilter("Barnee Karra Tobacco")}>
